...
### 1. Set Up
1. Download [ Windows 3rdParty ](https://drive.google.com/uc?export=download&id=1CbJFaeBoZ4pq-H0yntpZoCXKWiHACtNd) or [ Linux 3rdParty ](https://drive.google.com/uc?export=download&id=1H-HeqOXuVqSWpIwzJMdDfufm7Quc0otg) and place the extracted catalog next to andromeda src code like this:
    ```
        path/to/catalog/
            ├── andromeda
            ├── 3rdParty
