...
namespace Andromeda
{
	namespace Renderer
	{
		...
		void OpenGLRenderer::OpenGLRendererImpl::Initialize()
		{
        ...
        GLuint OpenGLRenderer::OpenGLRendererImpl::CreateShaderProgram(const char* vertexShaderSource, const char* fragmentShaderSource)
        {
        ...
        void OpenGLRenderer::OpenGLRendererImpl::CheckCompileErrors(GLuint shader, const std::string& type)
        {
            GLint success;
            GLchar infoLog[1024];
            if (type != "PROGRAM")
