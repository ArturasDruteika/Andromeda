#ifndef PHYSICAL_PROPERTIES__MATERIALS_LIBRARY__HPP
#define PHYSICAL_PROPERTIES__MATERIALS_LIBRARY__HPP
...
{
	class PHYSICAL_PROPERTIES_API MaterialLibrary
	{
	public:
		MaterialLibrary();
...
#endif // PHYSICAL_PROPERTIES__MATERIALS_LIBRARY__HPP