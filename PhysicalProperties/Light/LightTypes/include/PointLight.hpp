#ifndef PHYSICAL_PROPERTIES__POINT_LIGHT__HPP
#define PHYSICAL_PROPERTIES__POINT_LIGHT__HPP
...
{
	class PHYSICAL_PROPERTIES_API PointLight
...
#endif // PHYSICAL_PROPERTIES__POINT_LIGHT__HPP