#ifndef PHYSICAL_PROPERTIES__DIRECTIONAL_LIGHT__HPP
#define PHYSICAL_PROPERTIES__DIRECTIONAL_LIGHT__HPP
...
{
	class PHYSICAL_PROPERTIES_API DirectionalLight
...
#endif // PHYSICAL_PROPERTIES__DIRECTIONAL_LIGHT__HPP