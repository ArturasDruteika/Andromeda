...
namespace Andromeda::Rendering
{
	...
	void SceneObjects::AddObject(int id, IRenderableObject* object)
	{
		...
		if (object->IsLuminous())
		{
			AddLuminousObject(id, dynamic_cast<Space::LuminousBehavior*>(object->GetLightBehavior()));
		}
	}
	...
	void SceneObjects::AddLuminousObject(int id, Space::LuminousBehavior* pLuminousObject)
	{
