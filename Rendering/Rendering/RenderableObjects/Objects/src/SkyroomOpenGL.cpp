...
namespace Andromeda::Rendering
{
	...
	Space::ILightBehavior* SkyroomOpenGL::GetLightBehavior() const
	{
		return m_pSkyroomOpenGLImpl->GetLightBehavior();
	}

	void SkyroomOpenGL::SetLuminousBehavior(Space::ILightBehavior* behavior)
	{
	...
	const std::vector<Space::Vertex>& SkyroomOpenGL::GetVertices() const
	{
