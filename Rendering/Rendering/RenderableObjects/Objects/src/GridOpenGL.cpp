...
namespace Andromeda::Rendering
{
		...
		)
	{
        ...
        Init();
        RenderableObject::UpdateModelMatrix(Space::TransformationType::ALL);
	}
    ...
    const std::vector<Space::Vertex>& GridOpenGL::GetVertices() const
    {
        return m_vertices;
    }
    ...
    Space::ILightBehavior* GridOpenGL::GetLightBehavior() const
    {
        return nullptr;
    }
    ...
    void GridOpenGL::SetLuminousBehavior(Space::ILightBehavior* behavior)
    {
    ...
    void GridOpenGL::SetGridSize(int size)
    {
        ...
        RenderableObjectOpenGL::UpdateModelMatrix(Space::TransformationType::ALL);
    }
    ...
    void GridOpenGL::SetSpacing(float spacing)
    {
        ...
        UpdateModelMatrix(Space::TransformationType::ALL);
    }
