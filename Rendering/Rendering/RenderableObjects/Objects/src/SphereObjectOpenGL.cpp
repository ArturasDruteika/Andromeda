...
namespace Andromeda::Rendering
{
	...
	const std::vector<Space::Vertex>& SphereObjectOpenGL::GetVertices() const
	{
	...
	Space::ILightBehavior* SphereObjectOpenGL::GetLightBehavior() const
	{
	...
	void SphereObjectOpenGL::SetLuminousBehavior(Space::ILightBehavior* behavior)
	{
